...
<template>
  <main class="page">
    ...
    <div class="w-full h-full flex flex-col font-fira_regular">
      ...
      <div v-auto-animate class="w-full h-full px-5 md:px-10 lg:px-20 py-3 grid gap-y-3 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 lg:self-center overflow-x-hidden overflow-y-auto custom-scrollbar">
